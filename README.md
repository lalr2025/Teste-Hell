...
- Exportação de consolidado CSV (com data/hora, latitude/longitude e metadados por foto: `photoNFileName`, `photoNMimeType`, `photoNCapturedAt`, `photoNBase64`, para N=1..5).
